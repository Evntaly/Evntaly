  ...
  return (
      ...
      (n.ColorTXT = function () {
          d("[data-color]").each(function () {
              var e, t;
              (t = "color"), (e = d((e = this))), "" !== (t = e.data(t || "color")) && e.css("color", t);
          });
      }),
      ...
      (n.AddInBody = function (e, t) {
          var a = { prefix: "nk-", class: "", has: "has" },
              ...
              e = a;
          (t.prefix = !1 !== t.prefix ? t.prefix : ""), (t.has = "" !== t.has ? t.has + "-" : ""), (e = "" !== t.class ? t.class : t.has + e), d("." + t.prefix + a).exists() && !s.hasClass(e) && s.addClass(e);
      }),
      (n.Toggle = {
          ...
          overlay: function (e, t, a) {
              var o;
              !0 === a.break && ((o = d(e).data("toggle-screen")), (a.break = n.Break[o])),
                  d(e).hasClass(a.content) && n.Win.width < a.break ? d(e).after('<div class="' + t + '" data-target="' + a.self + '"></div>') : this.overlayRemove(t);
          },
          ...
          dropMenu: function (e, t) {
              var a = { active: "active", self: "link-toggle", child: "menu-sub", speed: 400 },
                  o = t ? l(a, t) : a,
                  s = d(e).parent(),
                  t = s.children("." + o.child);
              (o.speed = 5 < t.children().length ? o.speed + 20 * t.children().length : o.speed),
                  t
                      .slideToggle(o.speed)
                      .find("." + o.child)
                      .slideUp(o.speed),
              ...
              d(e).each(function () {
                  ...
                  d(this)
                      ...
                      .on("changeDate", function (e) {
                          0 !== e.dates.length ? d(this).parent().addClass("focused") : d(this).parent().removeClass("focused");
                      });
              });
      }),
              ...
              d(e).each(function () {
                  ...
                  var e = d(this).data("time-format"),
                      ...
                      e = {
                          ...
                          interval: "" !== t ? t : 15,
                          change: function (e) {
                              !1 !== e ? d(this).parent().addClass("focused") : d(this).parent().removeClass("focused");
                          },
                      },
                      t = a ? l(e, a) : e;
                  d(this).timepicker(t);
...
(
  (NioApp = (function (e, t, a) {
      ...
      return e(a).ready(i), e(t).on("load", n), e(t).on("resize", d), (o.coms = s), (o.docReady = i), (o.winLoad = n), (o.onResize = d), o;
